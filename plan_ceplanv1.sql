...
-- Tiempo de generación: 22-04-2024 a las 16:29:11
...
(4, 'papel bond', '2.1.15.12', 'PERSONAL NOMBRADO', 'paquete', 10, 1, 'enero', 2, 1),
(5, 'globos', '2.1.15.22', 'OTRAS RETRIBUCIONES Y COMPLEMENTOS', 'paquete', 23, 5, 'Febrero', 3, 4),
(6, 'platos de plastico', '2.1.15.21', 'PERSONAL NOMBRADO', 'paquete', 23, 11, 'Febrero', 3, 1);
...
(4, 'Proveer la actividad minera y energia electrica en la region de Puno', 'OEI.05', 1);
...
(1, '71052981', 'Joel Santos', 'Gomez Alanoca', 9857452871, 'ioelgomez2019@gmail.com', 'dad236ad4e24c1562e777109f7989790175ff96de62851ee2bef4b89f0ddce6d', '24252622', 'Joel sga', 'peru lima', 'fbb125c9cb3c4d6170d6-9e9988bffda43e223ab4-dfec8aa78eb7832376b0-6ec89158ab4752a59347', 1, '2020-08-13 00:51:44', 1, 'DGI'),
...
(9, '46548454', 'Alan', 'Arenales', 45687954, 'alan@info.com', 'dc4e32154482eff8c1a2061374a0fc2ca40fbf9b893197e949c79be535b06b23', 'CF', 'Alann', 'Ciudad', '', 7, '2020-10-11 01:30:23', 1, ''),
...
--
ALTER TABLE `actividad`
  MODIFY `idcodigo_act` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `cuadro_necesidades`
--
ALTER TABLE `cuadro_necesidades`
  MODIFY `idNecesidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `unidad_medidaaei`
  MODIFY `idunidad_medidaaei` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `unidad_medidaoei`
--
ALTER TABLE `unidad_medidaoei`
  MODIFY `idunidad_medidaoei` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
